...
\begin{equation}
  \begin{aligned}
    \phi_U(U)=&\int_0^\infty d\omega \left\{\Theta(-U)\qty[a^u_\omega \phi^u_\omega(u(U))+a_\omega^{u*}\phi_\omega^u(u(U))^*] \right\\
    &\left+\Theta(U)\qty[a^{\tilde u}_\omega \phi^{\tilde u}_\omega(\tilde u(U))+a_\omega^{\tilde u*}\phi_\omega^{\tilde u}(\tilde u(U))^*]\right\},
  \end{aligned}
\end{equation}
