...
Tenemos que describir la formación de un agujero negro y la variación de estado de vacío
para un observador asintótico.
Los modos salientes que escapan la materia en colapso poco antes de formarse el horizonte

Cerca del horizonte, si definimos la coordenadas de Kruskal-Szeckeres

\begin{equation}
  \phi^{\bar u}_\omega \propto e^{i\omega 4M\ln \abs{\frac{u'}{4M}}}.
\end{equation}
