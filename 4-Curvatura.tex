...
\end{equation}
Escogemos la métrica de la worldsheet como la de un toro 
\begin{equation}
  h_{\alpha\beta} =
\qty(
\begin{array}{cc}
...
La divergencia de Hagedorn aparece al calcular la integral de camino de una cuerda que se enrolla en el tiempo 
...
\end{equation}
donde $\nabla^2 = G^{ij}\nabla_i \partial_j$.
La integral de camino asociada a está acción se calcula buscando los valores
...
Este resultado refuerza la idea de la existencia de un horizonte \emph{estirado}, como se comenta en 
\cite{Susskind1993}.
...
Esta es la causa de la divergencia de la entropía de un agujero negro en teoría cuántica de campos.
