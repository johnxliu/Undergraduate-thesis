...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
\todo{Interpretación partícula, comparación}
...
Faltaría considerar correcciones a la acción a orden superior en $\alpha'$.
...
Este es otro motivo para pensar que las cuerdas formarían una membrana alrededor del agujero
negro.
