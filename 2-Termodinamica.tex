...
Otra interpretación alternativa se basa en que al hacer la integral de camino hemos de sumar sobre 
...
\begin{tikzpicture}[scale=2]
    ...
    \draw[very thin, blue] (-\x,0) -- (-\x,2.1);
    \node at (0.25,1.7) {$\mathcal F$};
    \node at (2.2,-0.17) {$\tau_1$};
    \node at (0.15,2) {$\tau_2$};
    \begin{scope}
        \begin{pgfonlayer}{background}
            \clip (-0.5,0) rectangle (0.5,2.2);
            \clip   (1,2.2) -| (-1,0) arc (180:0:1) -- cycle;
            \fill[gray,opacity=0.8] (-1,-1) rectangle (1,2.1);
        \end{pgfonlayer}
    \end{scope}
\end{tikzpicture}
